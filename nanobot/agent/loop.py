    ...
    async def _run_agent_loop(
        ...
        while iteration < self.max_iterations:
            ...
            if response.has_tool_calls:
                ...
                # Skip retry for thinking models: appending an assistant message
                # as a prefill is incompatible with enable_thinking on vllm/hosted
                # models, and thinking models don't exhibit the interim-text pattern.
                if (
                    not tools_used
                    and not text_only_retried
                    and final_content
