...
class TranscriptionConfig(BaseModel):
    """Transcription configuration for voice/audio processing."""

    provider: str = "local"  # "local" or "groq"
    model_size: str = "base"  # For local: "tiny", "base", "small", "medium", "large-v2", "large-v3"
    device: str = "auto"  # For local: "cpu", "cuda", or "auto"
    compute_type: str = "auto"  # For local: "int8", "float16", "float32", or "auto"
